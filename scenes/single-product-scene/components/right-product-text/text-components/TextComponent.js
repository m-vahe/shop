            ...
            <div className={"text-component-body"}>
                <p className={"text1"}>
                    * Preise inkl. Mwst., versandkostenfrei innerhalb Deutschlands.<br/>
                    Lieferungen in die Schweiz erfolgen ohne MwSt. - beachten Sie bitte die abweichenden Bedingungen.<br/>
                ...
                <p className={"text3"}>
                    Verantwortlich Person in der EU <br/>

                    <a href="mailtp:aramman1999@gmail.com">
                        <span>
