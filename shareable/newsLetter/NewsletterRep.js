        ...
        <>
            <div className='newsLetter__container'>
                ...
                <div className='newsLetter__container__action'>
                    <form action='#' className='newsLetter__container__action__form' onSubmit={onSubmit}>
                        <input
                            type='text'
                            name={"name"}
                            placeholder={'Vorname'}
                        ...
                        <Tooltip title={"message is rquired and must contain at least 150 characters"} color={"red"}
                                 visible={emailSuccess ? true : false} placement="bottomRight">
                            <input
                                type='email'
                                placeholder={'Email adresse'}
                                className={`newsLetter__container__action__form--email ${emailSuccess ? "input-error" : null}`}
