    ...
    return(
        ...
        >
            ...
            <div className={"magazin__single__item__body__text"}>
                ...
                <div className={`magazin__single__item__body__text__hover ${transformed}`}>
                    <h3 className={"magazin__single__item__body__text__hover--name"}>{elem.name}</h3>
                    <p className={"magazin__single__item__body__text__hover--type"}>{elem.type}</p>
                    <p className={"magazin__single__item__body__text__hover--type2"}>{elem.type2}</p>
                    <p className={"magazin__single__item__body__text__hover--price"}>{elem.price}</p>
                    <button className={"magazin__single__item__body__text__hover--button"}>
                        <p>Quick shop</p>
                        {" "}
