...
const ProductsWithLeftText = ({
  ...
  const addToFavorites = (id, variantId, e) => {
    console.log(e);
    if (!isAuthenticated) {
                ...
                <div className={" first-prod-items col-lg-3"} key={i}>
                  <div className={"picture-body-prod"}>
                    ...
                    <svg
                      ...
                      onClick={() => {
                        addToFavorites(e.id, e.variants_of_a_products[0].id, e);
                        console.log(e);
                      }}
                      style={
                        e.variants_of_a_products[0].favorite
                          ? { stroke: "#000000" }
                          : { stroke: "#7b7b7b" }
                      }
                    >
                  ...
                  <h3 className={"prod-txt-price"}>
                    {formatter.format(e.variants_of_a_products[0].price || 0)}
                  </h3>
