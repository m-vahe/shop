...
import {getProductsWithFilter,getEightProductsWithFilter} from "../../services/actions/products";
...
const ProductsWithLeftText = ({ products, leftText, addToWishList,getFour }) => {
                ...
                <div className={' first-prod-items col-lg-3'} key={i}>
                  ...
                  >
                    ...
                    <svg
                        ...
                        style={e.favorit ? { stroke: '#000000' } : { stroke: '#7b7b7b' }}
                    >
                      <path
